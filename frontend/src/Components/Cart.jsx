...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        const getCartProduct = async () => {
            ...
            try {
                ...
                const response = await axios.post("https://swiggy-mern-stack-1.onrender.com/api/buyer/getCartProducts", { userId: state?.user?.userId })
    ...
    async function removeProductfromCart(pId) {
        setLoading(true)
        try {
            const response = await axios.post("https://swiggy-mern-stack-1.onrender.com/api/buyer/removeproduct", { pId, userId: state?.user?.userId })
            if (response.data.success) {
                dispatch({
    ...
    const buyNow = async () => {
        try {
            ...
            const response = await axios.post('https://swiggy-mern-stack-1.onrender.com/api/buyer/buyNow', { userId: state?.user?.userId, cartProduct, totalPrice, totalProduct })
